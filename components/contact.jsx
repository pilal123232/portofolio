            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:abdulmoeinkabahalil@gmail.com"
              ...
              <div className="flex items-start gap-4">
                <div className="p-3 bg-gray-800 rounded-lg text-green-500">
                  <MessageCircle size={20} />
                </div>
                <div>
                  <h4 className="font-medium mb-1">WhatsApp</h4>
                  <a
                    href="https://wa.me/message/4XT4F4IV2NGBD1"
                    target="_blank"
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Aleppo, Syria</p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Abdul Moein Kaba Khalil"
                  />
                </div>
                <div>
                  <label
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                    placeholder="abdulmoeinkabahalil@gmail.com"
                  />
                </div>
              </div>
